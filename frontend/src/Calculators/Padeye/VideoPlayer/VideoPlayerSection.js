...
// ✅ Lazy-load the YouTube player (prevents main thread blocking)
...
export default function VideoPlayerSection() {
  ...
  const [showPlayer, setShowPlayer] = useState(false); // 👈 Load player only when visible
      ...
      >
        ...
        {showPlayer ? (
          <Suspense fallback={<div style={{ height: "80vh", background: "#000" }} />}>
            <ReactPlayer
              ref={playerRef}
              url="https://www.youtube.com/watch?v=9dGx_7VefRI"
              playing={isPlaying}
              controls={false}
          ...
          // 👇 Keeps layout stable (prevents CLS)
          <div
            style={{
              width: "100%",
              height: "80vh",
  ...
  aria-label="Video Progress"
          ...
          <div className="controls">
            ...
            <button className="theater-mode-btn" aria-label="Toggle theater mode" onClick={toggleTheaterMode}>
              <MdOutlineFitScreen />
            </button>
